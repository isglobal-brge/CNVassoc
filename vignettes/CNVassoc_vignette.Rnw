...
if (requireNamespace("xtable", quietly=TRUE)) {
  xtable::xtable(taula,"Comparison of RR estimated by the gold standard model, a latent class model (LC) and naive approach",label="table-compare")
} else {
  cat("xtable is not available\n")
}
@
